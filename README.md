...
### Using `Flavored` for Test Transformations
...
The `Flavored` type has the following structure:

```haskell
data Flavored a = Flavored
  { flavoring :: TestTree -> TestTree  -- ^ Transformation function
